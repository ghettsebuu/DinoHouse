// src/components/Nivel2/Nivel2.jsx
...
const Nivel2 = ({ mostrarActividad, mostrarMemoryGame, mostrarLaboratorio, mostrarPalabras, codigoAcceso, onLevelUp }) => {
  ...
  return (
    <div className='nivel'>
      ...
      <BotonAvanzarNivel codigoAcceso={codigoAcceso} level={2} onLevelUp={onLevelUp} />
